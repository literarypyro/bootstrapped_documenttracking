...
if(isset($_POST['target_id'])){
	...
	$update="insert into document_routing(from_name,from_office,alter_from,alter_position,request_date,input_time,reference_no,synced) ";
	$update.=" VALUES ";
	$update.="('".$from_name."','".$from_division."','".$alter_from."','".$alter_position."','".$reply_date."','".$reply_date."','".$ref_id."','false')";
