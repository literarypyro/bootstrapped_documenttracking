														  ...
														  <div class="modal-content">
															...
															?>			
																<tr>	
																	...
																	<td style='display:none' id="label_officer_stn_<?php echo $row['department_code']; ?>" name="label_officer_stn_<?php echo $row['department_code']; ?>"><?php retrieveOfficerListHTML2($db,"officer_stn_".$row['department_code'],$row['department_code']); ?></td>
																	...
																	<select class='form-control'  name='action_stn_<?php echo $row['department_code']; ?>' id='action_stn_<?php echo $row['department_code']; ?>' onchange="updateAction('action_stn_<?php echo $row['department_code']; ?>')">
																	<?php
																	...
																	?>
																		<option value='<?php echo $row2['action_code']; ?>' data-action='<?php echo $row2['action_description']; ?>'><?php echo $row2['action_description']; ?></option>
																	<?php
																	}
																	?>
